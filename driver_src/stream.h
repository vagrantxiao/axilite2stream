...
public:
	...
	unsigned int stream1_read();
	unsigned int stream2_read();
	unsigned int stream3_read();
	unsigned int stream4_read();
	unsigned int stream5_read();
	unsigned int stream6_read();
	unsigned int stream7_read();
