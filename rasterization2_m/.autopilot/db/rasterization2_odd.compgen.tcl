...
set out_width 18
set exp (i0+i1)*i2
set arg_lists {i0 {8 0 +} i1 {8 0 -} s {9 0 +} i2 {9 1 +} p {18 1 +} c_expval {c} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
set out_width 18
set exp (i0+i1)*i2+i3
set arg_lists {i0 {8 0 +} i1 {8 0 -} s {9 0 +} i2 {9 1 +} m {18 1 +} i3 {18 1 -} p {18 1 +} c_expval {c} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
set ID 13
set hasByteEnable 0
set MemName rasterization2_odbkb
