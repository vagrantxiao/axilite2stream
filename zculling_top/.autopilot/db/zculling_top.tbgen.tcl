set C_TypeInfoList {{ 
"zculling_top" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"Input_1": [[], {"reference": "0"}] }, {"Input_2": [[], {"reference": "0"}] }, {"Output_1": [[], {"reference": "0"}] }],["1","2","3"],""],
 "1": [ "zculling_top_out_1", [[], {"scalar": "int"}],""],
 "2": [ "zculling_top_in_2", [[], {"scalar": "int"}],""],
 "3": [ "zculling_top_in_1", [[], {"scalar": "int"}],""], 
"0": [ "stream<ap_uint<32> >", {"hls_type": {"stream": [[[[],"4"]],"5"]}}], 
"4": [ "ap_uint<32>", {"hls_type": {"ap_uint": [[[[], {"scalar": { "int": 32}}]],""]}}],
"5": ["hls", ""]
}}
set moduleName zculling_top
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4"],
		...
		"Port" : [
			...
			{"Name" : "zculling_top_in_1", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "zculling_top_in_2", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "counter_V", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "z_buffer_V", "Type" : "Memory", "Direction" : "IO"},
			{"Name" : "zculling_top_out_1", "Type" : "OVld", "Direction" : "IO"}]},
...
set ArgLastReadFirstWriteLatency {
	zculling_top {
		...
		zculling_top_in_1 {Type IO LastRead -1 FirstWrite -1}
		zculling_top_in_2 {Type IO LastRead -1 FirstWrite -1}
		counter_V {Type IO LastRead -1 FirstWrite -1}
		z_buffer_V {Type IO LastRead -1 FirstWrite -1}
		zculling_top_out_1 {Type IO LastRead -1 FirstWrite -1}}}
