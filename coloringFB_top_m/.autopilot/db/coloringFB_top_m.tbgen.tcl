set C_TypeInfoList {{ 
"coloringFB_top_m" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"Input_1": [[], {"reference": "0"}] }, {"Input_2": [[], {"reference": "0"}] }, {"Output_1": [[], {"reference": "0"}] }],["1","2","3"],""],
 "1": [ "coloringFB_top_m_out_1", [[], {"scalar": "int"}],""],
 "2": [ "coloringFB_top_m_in_2", [[], {"scalar": "int"}],""],
 "3": [ "coloringFB_top_m_in_1", [[], {"scalar": "int"}],""], 
"0": [ "stream<ap_uint<32> >", {"hls_type": {"stream": [[[[],"4"]],"5"]}}], 
"4": [ "ap_uint<32>", {"hls_type": {"ap_uint": [[[[], {"scalar": { "int": 32}}]],""]}}],
"5": ["hls", ""]
}}
set moduleName coloringFB_top_m
...
set C_modelName {coloringFB_top_m}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "coloringFB_top_m_in_1", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "counter_V", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "frame_buffer_V", "Type" : "Memory", "Direction" : "IO"},
			{"Name" : "coloringFB_top_m_out", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "coloringFB_top_m_in_s", "Type" : "OVld", "Direction" : "IO"}]},
...
set ArgLastReadFirstWriteLatency {
	coloringFB_top_m {
		...
		Input_2_V_V {Type I LastRead 7 FirstWrite -1}
		Output_1_V_V {Type O LastRead -1 FirstWrite 5}
		coloringFB_top_m_in_1 {Type IO LastRead -1 FirstWrite -1}
		counter_V {Type IO LastRead -1 FirstWrite -1}
		frame_buffer_V {Type IO LastRead -1 FirstWrite -1}
		coloringFB_top_m_out {Type IO LastRead -1 FirstWrite -1}
		coloringFB_top_m_in_s {Type IO LastRead -1 FirstWrite -1}}}
