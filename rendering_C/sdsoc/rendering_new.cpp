...
// find the max from 3 integers
unsigned char find_max_new( unsigned char in0, unsigned char in1, unsigned char in2 )
{
...
// find the min from 3 integers
unsigned char find_min_new( unsigned char in0, unsigned char in1, unsigned char in2 )
{
  if (in0 < in1)
  {
    if (in0 < in2)
...
void data_redir(hls::stream<ap_uint<32> > & Input_1,
		hls::stream<ap_uint<32> > & Output_1)
{
